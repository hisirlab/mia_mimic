...
weightPath = r"C:\Users\DELL\Desktop\AMIA\model_2\mobilenetv2\H1_model_MobileNetV2.pth"
...
def train_model_with_early_stopping(model, train_loader, val_loader, criterion, optimizer, device, epochs=50,
                                    patience=5):
...
if __name__ == '__main__':
    ...
    model = build_model_mobilenetv2().to(device)
    criterion = nn.BCELoss()
    optimizer = optim.Adam(model.parameters(), lr=1e-4)

    save_dir = r"D:\Codes\PycharmProjects\amia\results_2\Mobilenetv2\H1_1"
