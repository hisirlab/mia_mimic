...
weightPath = r"C:\Users\DELL\Desktop\AMIA\model_2\vgg19\H1_model_VGG19.pth"
...
if __name__ == '__main__':
    ...
    model = build_model_vgg19().to(device)
    criterion = nn.BCELoss()
    optimizer = optim.Adam(model.parameters(), lr=1e-4)

    save_dir = r"D:\Codes\PycharmProjects\amia\results_2\VGG19\H1_1"
