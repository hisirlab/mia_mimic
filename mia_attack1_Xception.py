...
weightPath = r"C:\Users\DELL\Desktop\AMIA\model_2\xception\H1_model_Xception.pth"
...
if __name__ == '__main__':
    ...
    model = build_model_xception().to(device)
    criterion = nn.BCELoss()
    optimizer = optim.Adam(model.parameters(), lr=1e-5)

    save_dir = r"D:\Codes\PycharmProjects\amia\results_2\Xception\H1_1"
